...
class SDKSERVICEApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.execute_strategy_endpoint = _Endpoint(
            settings={
                'response_type': (SDKResponse,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/smart-contract/sdk/v2.0/yieldster/execute-strategy',
                'operation_id': 'execute_strategy',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.protocol_interaction_endpoint = _Endpoint(
            settings={
                'response_type': (SDKResponse,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/smart-contract/sdk/v2.0/yieldster/protocol_Interaction',
                'operation_id': 'protocol_interaction',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.return_json_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/smart-contract/getJson',
                'operation_id': 'return_json',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.test_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/smart-contract/test',
                'operation_id': 'test',
                'http_method': 'GET',
                'servers': None,
            },
    ...
    def execute_strategy(
        ...
        **kwargs
        ...
        >>> thread = api.execute_strategy(strategy_plan, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['strategy_plan'] = \
            strategy_plan
        return self.execute_strategy_endpoint.call_with_http_info(**kwargs)
    ...
    def protocol_interaction(
        ...
        **kwargs
        ...
        >>> thread = api.protocol_interaction(str, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['str'] = \
            str
        return self.protocol_interaction_endpoint.call_with_http_info(**kwargs)

    def return_json(
        self,
        **kwargs
    ):
        """return_json  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.return_json(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.return_json_endpoint.call_with_http_info(**kwargs)
