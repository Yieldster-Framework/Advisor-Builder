...
class PATHEXECUTIONSERVICEApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.check_for_direct_paths_endpoint = _Endpoint(
            settings={
                'response_type': (SDKResponse,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/path-execution/v2.0/yieldster/check-direct-paths',
                'operation_id': 'check_for_direct_paths',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.fetch_direct_graph_endpoint = _Endpoint(
            settings={
                'response_type': (SDKResponse,),
                'auth': [
                    'bearer-jwt'
                ],
                'endpoint_path': '/path-execution/v2.0/yieldster/fetch-direct-paths',
                'operation_id': 'fetch_direct_graph',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def check_for_direct_paths(
        ...
        **kwargs
        ...
        >>> thread = api.check_for_direct_paths(from_token, to_token, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['to_token'] = \
            to_token
        return self.check_for_direct_paths_endpoint.call_with_http_info(**kwargs)
    ...
    def fetch_direct_graph(
        ...
        **kwargs
        ...
        >>> thread = api.fetch_direct_graph(from_token_amount, from_token, to_token, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['to_token'] = \
            to_token
        return self.fetch_direct_graph_endpoint.call_with_http_info(**kwargs)
